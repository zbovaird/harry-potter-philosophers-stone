...
Drop character exports into `assets/characters/` (e.g. `harry.glb`). The loader is ready via `AssetLibrary`; current builds use detailed procedural heroes so the game runs without binary assets.
